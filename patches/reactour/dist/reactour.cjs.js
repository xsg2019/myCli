...
function getWindow() {
  var w = Math.max(document.documentElement.offsetWidth, window.innerWidth || 0);
...
function Tour(_ref) {
  ...
  return isOpen ? React__default.createElement(Portal, null, React__default.createElement(GlobalStyle, null), React__default.createElement(SvgMask, {
  ...
  }), React__default.createElement(FocusLock, null, React__default.createElement(Guide, {
    ref: helper,
    windowWidth: state.w,
    windowHeight: state.h,
    targetWidth: state.width,
    ...
    close: close,
    content: stepContent
  }, children) : React__default.createElement(React__default.Fragment, null, children, stepContent, (showButtons || showNavigation) && React__default.createElement(Controls, {
